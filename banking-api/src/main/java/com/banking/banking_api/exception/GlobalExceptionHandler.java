...
import com.banking.banking_api.exception.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    // 403 FORBIDDEN
    @ExceptionHandler(com.banking.banking_api.exception.AccessDeniedException.class)
    public ResponseEntity<ErrorResponse> handleAccessDenied(
            com.banking.banking_api.exception.AccessDeniedException ex) {
