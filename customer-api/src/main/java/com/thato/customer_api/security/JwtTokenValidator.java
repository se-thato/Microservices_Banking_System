...
public class JwtTokenValidator {
    ...
    private final com.thato.customer_api.security.JwtTokenExtractor extractor;
    // We need the extractor to READ the token before we can validate it

    public JwtTokenValidator(com.thato.customer_api.security.JwtTokenExtractor extractor) {
